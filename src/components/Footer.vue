...
onMounted(async () => {
  await fetch('https://api.github.com/repos/alqix/android_device_samsung_sm7325-common/commits/15.0')
...
<template>
  <div class="flex justify-between mt-10 gap-5 text-sm text-catppuccin-gray">
    ...
    <a href="https://github.com/alqix/android_device_samsung_sm7325-common" target="_blank" class="whitespace-nowrap underline">i ❤️ boobs</a>
  </div>
</template>
