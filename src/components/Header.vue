...
const connectWebSocket = () => {
  ...
  ws.value.onopen = () => {
    ws.value.send(JSON.stringify({
      op: 2,
      d: { subscribe_to_id: '947980212883312721' }
    }));
  };
...
<template>
  ...
  <div>
    alqix, 16 years-old. self-taught developer, gentoo enjoyer.
  </div>
  ...
  <div class="flex gap-10 mt-5 text-xl">
    <a href="https://github.com/alqix/" target="_blank" class="flex items-center justify-center">
      <font-awesome-icon :icon="['fab', 'github']" class="w-5 h-5" />
    </a>
    <a href="https://t.me/alqix0" target="_blank" class="flex items-center justify-center">
      <font-awesome-icon :icon="['fab', 'telegram']" class="w-5 h-5" />
    </a>
    <a href="https://discord.com/user/947980212883312721" target="_blank" class="flex items-center justify-center">
